...
<title>VT320 Soft Character Sets</title>
<link href="../../terminal.css%3Fn=1.css" rel="stylesheet"/>
...
<ol>
<li><a href="https://www.vt100.net/"><svg xmlns="http://www.w3.org/2000/svg" width="92" height="16" version="1.1" id="vt100-net-site-logo">
...
<li><a href="https://www.vt100.net/dec/" title="Digital Equipment Corporation">DEC</a></li>
<li><a href="index.html">VT320</a></li>
</ol>
</nav>
</header>

<h1>VT320 Soft Character Sets</h1>
<p class="byline"><a href="https://hisdeedsaredust.com/">Paul Flo Williams</a>, <time datetime="1998-04-30">30 April 1998</time></p>
<p>The Digital VT320, like the VT200 Series before it, allows character glyphs to be created
and sent to the terminal as a Dynamically Redefined Character Set (DRCS). In this way you
can use up to 96 custom character shapes on the screen at one time. These extra characters can
be used to provide letter shapes that are missing from the built-in sets, or they can
even be used to pretend that the terminal has a graphics capability.</p>

<figure>
<img src="snap-animacp-large.png"/>
<figcaption>AnimACP is an application which displays data captured
during runs of a real-time system. An ACP (Activity, Channel, Pool) diagram shows the processes
and message queues in the system. As the logged data is played through, the processes flash when
they are running. One of a number of bar charts is displayed on the right. The charts are
dynamically scalable. The data in the charts is displayed to a resolution of a single pixel.</figcaption>
</figure>

<h2>Designing a VT320 font</h2>
<p>In 80-column mode, the VT320 displays characters in a matrix 15 pixels wide by 12 pixels high.
In 132-column mode, this drops to 9 pixels wide by 12 pixels high. However, each pixel has a
rather extreme aspect ratio, making it nearly three times as high as it is wide. Vertical lines of
only one pixel wide will tend to disappear on the screen. For this reason, the
<a href="glyphs.html">built-in glyphs</a> have vertical strokes three pixels wide.</p>
<h2>Downloading the font</h2>
<p>Downloading the font to the terminal is accomplished with the control sequence DECDLD:</p>
<p><code>DCS</code> Pfn <code>;</code> Pcn <code>;</code> Pe <code>;</code> Pcmw <code>;</code>
Pw <code>;</code> Pt <code>;</code> Pcmh <code>;</code> Pcss <code>{</code> Dscs
Sxbp1 <code>;</code> Sxbp2 <code>;</code> ... <code>;</code> Sxbpn <code>ST</code></p>
<p><code>DCS</code> is the 8-bit control code Device Control Sequence, which can be represented by
the 7-bit sequence <code>ESC P</code>. <code>ST</code> is the 8-bit control code String Terminator,
which can be represented by the 7-bit sequence <code>ESC \</code>.</p>
<h3>Parameters</h3>
<p>The DECDLD parameters are detailed in the table below, taken directly from <cite><a href="https://www.vt100.net/docs/vt320-uu/">Installing
and Using the VT320 Video Terminal</a></cite> <small>(EK-VT320-UU)</small>.</p>
<table>
<thead>
<tr>
<th>Parameter</th>
...
<th>Pfn</th>
<td>Font number</td>
<td>Selects the DRCS font buffer to load.
<p>The VT320 has one DRCS font buffer. Pfn has two valid values, 0 and 1.
Both values refer to the same DRCS buffer.</p></td>
</tr>
<tr>
<th>Pcn</th>
<td>Starting character</td>
<td>Selects where to load the first character in the DRCS font buffer.
The location corresponds to a location in the ASCII code table.
<p>Pcn is affected by the character set size. (See Pcss below.) In a 94-character
set, a Pcn value of 0 or 1 means that the first soft character is loaded into position
2/1 of the character table. In a 96-character set, a Pcn value of 0 means the first
character is loaded into position 2/0 of the character table. The greatest
Pcn value is 95 (position 7/15).</p></td>
</tr>
<tr>
<th>Pe</th>
<td>Erase control</td>
<td>Selects which characters to erase from the DRCS buffer before loading the
new font.
<table>
<tbody>
<tr>
...
<td>=</td>
<td>erase all characters in the DRCS buffer with this number, width and rendition.</td>
</tr>
<tr>
<td class="numcol">1</td>
<td>=</td>
<td>erase only characters in locations being reloaded.</td>
</tr>
<tr>
<td class="numcol">2</td>
<td>=</td>
<td>erase all renditions of the soft character set (normal, bold, 80-column, 132-column).</td>
</tr>
</tbody>
</table></td>
</tr>
<tr>
<th>Pcmw</th>
<td>Character matrix width</td>
<td>Selects the maximum character cell width.
<table>
<caption>VT300 modes</caption>
<tbody>
<tr>
<td class="numcol">0</td>
<td>=</td>
<td>15 pixels wide for 80 columns, 9 pixels wide for 132 columns. <strong>(Default)</strong></td>
</tr>
<tr>
<td class="numcol">1</td>
<td>=</td>
...
<td class="numcol">2</td>
<td>=</td>
<td>5 × 10 pixel cell</td>
</tr>
<tr>
<td class="numcol">3</td>
<td>=</td>
<td>6 × 10 pixel cell</td>
</tr>
<tr>
<td class="numcol">4</td>
<td>=</td>
<td>7 × 10 pixel cell</td>
</tr>
<tr>
...
<td>=</td>
<td>15 pixels wide.</td>
</tr>
</tbody>
</table>
<p>If you omit a Pcmw value, the terminal uses the default character
width. Any Pcmw value over 15 is illegal.</p>
<p>Use Pcmw values 2 through 4 with VT220 compatible software. Remember that VT220 fonts
appear different VT320. Fonts designed specifically for the VT320 should use values
5 through 15.</p></td>
</tr>
<tr>
<th>Pw</th>
<td>Font width</td>
<td>Selects the number of columns per line (font set size).
<table>
<tbody>
<tr>
<td class="numcol">0</td>
<td>=</td>
<td>80 columns. <strong>(Default)</strong></td>
</tr>
<tr>
<td class="numcol">1</td>
<td>=</td>
...
<tr>
<th>Pt</th>
<td>Text or full-cell</td>
<td>Defines the font as a text font or full-cell font.
<table>
<tbody>
<tr>
<td class="numcol">0</td>
...
<p>Full-cell fonts can individually address all pixels in a cell.</p>
<p>Text fonts cannot individually address all pixels. If you specify
a text cell, the terminal automatically performs spacing and centering
of the characters.</p></td>
</tr>
<tr>
<th>Pcmh</th>
<td>Character matrix height</td>
<td>Selects the maximum character cell height.
<table>
<tbody>
<tr>
<td class="numcol">0</td>
<td>=</td>
<td>12 pixels high. <strong>(Default)</strong></td>
</tr>
<tr>
<td class="numcol">1</td>
<td>=</td>
...
<td>=</td>
<td>12 pixels high.</td>
</tr>
</tbody>
</table>
<p>Pcmh values over 12 are illegal. If the value of Pcmw is 2, 3 or 4, Pcmh is ignored.</p></td>
</tr>
<tr>
<th>Pcss</th>
<td>Character set size</td>
<td>Defines the character set as a 94- or 96-character graphic set.
<table>
<tbody>
<tr>
<td class="numcol">0</td>
<td>=</td>
<td>94-character set. <strong>(Default)</strong></td>
</tr>
<tr>
<td class="numcol">1</td>
<td>=</td>
<td>96-character set.</td>
</tr>
</tbody>
</table>
<p>The value of Pcss changes the meaning of the Pcn (starting character) parameter above.</p>
<dl>
<dt>If Pcss = 0 (94-character set)</dt>
<dd><p>The terminal ignores any attempt to load characters into the 2/0 or 7/15 table positions.</p>
<table>
<thead>
<tr>
<th>Pcn</th>
...
<td>column 7/row 14</td>
</tr>
</tbody>
</table></dd>
<dt>If Pcss = 1 (96-character set)</dt>
<dd><table>
<thead>
<tr>
<th>Pcn</th>
...
<tr>
<td class="numcol">95</td>
<td>column 7/row 15</td>
</tr>
</tbody>
</table></dd>
</dl></td>
...
<h3>Character Set Name</h3>
<p><strong>Dscs</strong> defines the character set name. It consists of from one to three
characters. The last
character of the name is a character in the range ‘0’ to ‘~’ (30<sub>16</sub> to 7E<sub>16</sub>).
There can be from zero to two name characters preceding this one, in the range <code>SP</code> to ‘/’
(20<sub>16</sub> to 2F<sub>16</sub>). This name will be used in the Select Character Set (SCS) sequence.
For example, if you call the new set ‘!!P’, the following sequence will designate it into G0. G0 is
mapped into GL by default, so the characters from the new set will be displayed when the terminal
receives codes in the range ‘!’ to ‘~’ (21<sub>16</sub> to 7E<sub>16</sub>):</p>
<pre>   ESC ( !!P</pre>
<p>Because the terminal can hold only one DRCS at a time, there is no particular advantage in
preferring one name over another. However, you may wish to provide a character set with a name
that will be used by an existing application, in which case the name would be already
decided. For example, the VT420 is supplied with a character set called DEC Technical, which has
the name ‘&gt;’. If you want to use this set on the VT320, you could download it and use your
application unchanged.</p>
<p>It is possible to give your set the same name as one of the built-in sets. In this case, your
definitions override the internal ones until your set is superseded by another downloaded set or
the terminal is reset.</p>
<h3>Glyph Definitions</h3>
<p>The definitions for each glyph follow immediately on from the character set name. The characters
are defined by a number of sixels, which are groups of six vertical pixels encoded as one ASCII
character. Each character definition consists of a set of up to 15 sixels for the top six pixel rows,
followed by a ‘/’ (2F<sub>16</sub>), followed by the sixels for the bottom six pixel rows.
Character definitions are separated from each other by semicolons (‘;’, 3B<sub>16</sub>).</p>
<p>The mapping from a group of six vertical pixels into a sixel character is quite simple. The pixels
can be read as a binary number, with the top pixel being the least significant bit. In other words,
we say that the top pixel has a value of 1 if it is on or 0 if it is off. The second pixel down
has a value of 2 if it is on or 0 if it is off. Each subsequent pixel has twice the value of the
one above it, so that the sixth pixel has a value of 32 if it is on and 0 if it is off. Add the
value of the pixels together, which gives a number between 0 and 63 inclusive. This is converted
to a character code by adding 63, which is the code of the question mark character, ‘?’. The
correspondence between each possible combination of six pixels and its sixel character is
illustrated below.</p>

<figure>
<img id="SIXFIG" src="sixel-characters.png" alt=""/>
</figure>

<h2>A Worked Example</h2>
<p><img id="BELLPIC" src="bell2.png" alt=""/>I used to define soft characters with an editor that I wrote for the VAX. However, I occasionally
drew characters on graph paper and coded them by hand. If you do this, remember the aspect ratio
of the pixels, nearly 3:1. I’ve drawn the character on the left, which is supposed to be
a ringing bell. We’ll convert this image into sixels.</p>
<p>First, we take the top six rows of pixels. The first column contains no black pixels, so its
value is sixel character from the table above is ‘?’. The same is true of the next two columns.
In column four, the lowest two pixels are black (lit), so the sixel character will be ‘o’. The
alternative way of working this out is to read the these pixel rows as a binary number as
described above and add on 63, the ASCII code of ‘?’. Reading these pixels as a binary number,
we get 110000<sub>2</sub> = 48<sub>10</sub>. Adding 63 to this gives us 111. The character with
ASCII code 111 is ‘o’.</p>
<p>If we continue this for the entire top row, we get the fifteen sixel values <code>???owYn||~ywo??</code>.
The bottom row gives us the sixel values <code>?IRJaVNn^NVbJRI</code>.</p>
<p>If we send the following sequence of characters to a VT320 in 80-column mode, it will define
a character set called ‘P’ and place the bell in the first position.
(The spaces in this example are just
for clarity; don’t type any spaces.)</p>
<p><code>ESC P 1;1;1;0;0;2;0;0 { P ???owYn||~ywo?? / ?IRJaVNn^NVbJRI ESC \</code></p>
<p>Our bell can now be accessed by designating character set ‘P’ into G0, which
is mapped into GL by default, so that sending the character ‘!’ (21<sub>16</sub>) to the terminal
will produce our new character instead of an exclamation mark. We’ll send a plain exclamation
mark to the terminal first to show the difference.</p>
<p><code>! ESC ( P !</code></p>
<p>If all has gone well, you should see the image below on the screen.</p>

<figure>
<img src="drcs-example.png" alt=""/>
</figure>

<h2>Other Resources</h2>
<ul>
<li>Justin Mason has written a <a href="http://taint.org/wk/JustinsSoftware">GIF viewer</a> for VT320s that uses the soft font facility.
He also has some <a href="http://jmason.org/software/vt320/">example output files</a>.</li>
<li>Adam Maulis has created some DCL scripts (for OpenVMS) demonstrating how to create <a href="http://ludens.elte.hu/ftp/vms/freeware/vt420drcs001.txt">soft characters on the VT420</a>. This
is very similar to the procedure described above. However, VT420 characters are 16 pixels tall, so they are made up of three rows of sixels.</li>
</ul>
<footer>
Copyright 1998 <a href="https://hisdeedsaredust.com">Paul Flo Williams</a>.
</footer>
</body>
</html>
*/
...
namespace InGameTerminal
{
	...
	public abstract class ExtraTerminalCommandData
	{
	...
	public struct TerminalCommand
	{
		...
		public int Y;
		public int Z;
		public ExtraTerminalCommandData ExtraData;
		public override readonly string ToString()
		{
			return CommandType.ToString() + "(" + X + ", " + Y + ", " + Z + ")" + (ExtraData != null ? "[" + ExtraData.ToString() + "]" : "");
		}
	}
}
